...
async def test_multilspy_rust_carbonyl():
    ...
    params = {
        ...
        "repo_commit": "5ce823681b62aa86cbf9fa9a3c6b11a4b0864c1d"
    }
    with create_test_context(params) as context:
        ...
        async with lsp.start_server():
            result = await lsp.request_document_symbols(str(PurePath("src/Framework/Attributes/AfterClass.php")))
            result = await lsp.request_references(str(PurePath("src/Framework/Attributes/AfterClass.php")), 19, 22)
